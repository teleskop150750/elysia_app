...
//   },
//   (table) => [
//     t.uniqueIndex("auto_main_nameplates_unique").on(table.name, table.model_id),
//   ],
// );
...
export const OfferOfferCountersTable = OfferSchema.table('offer_counters', {
  ...
  avito_card_view_phone_show_conversion_daily: t.integer().notNull().default(0),
  ...
  drom_card_view_phone_show_conversion_daily: t.integer().notNull().default(0),
